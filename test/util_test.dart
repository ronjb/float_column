...
void main() {
  test('findSpaceFor basic', () {
    expect(
      () => findSpaceFor(startY: 0, width: 0, height: 0, maxX: 0, floatL: [], floatR: []),
...

    {
      ...
      const fr = <Rect>[];
      expect(
        findSpaceFor(startY: 0, width: 100, height: 100, maxX: 200, floatL: fl, floatR: fr),
...

    {
      ...
      expect(
        findSpaceFor(startY: 0, width: 50, height: 50, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 80, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 50, height: 20, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 80, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 50, height: 10, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 90, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 1, height: 1, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 90, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 90, height: 10, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 90, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 80, height: 11, maxX: 100, floatL: fl, floatR: fr),
        const Rect.fromLTWH(10, 0, 80, 10),
      );
      expect(
        findSpaceFor(startY: 0, width: 80, height: 11, maxX: 100, floatL: fl, floatR: fr),
  ...
  test('findSpaceFor with textDir', () {
    {
      ...
      expect(
        findSpaceFor(startY: 0, width: 81, height: 11, maxX: 100, floatL: fl, floatR: fr),
